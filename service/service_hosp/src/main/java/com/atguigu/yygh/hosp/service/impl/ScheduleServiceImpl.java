...
public class ScheduleServiceImpl implements ScheduleService {
  ...
  public Map<String, Object> getRuleSchedule(
    ...
    Aggregation totalAgg =
            Aggregation.newAggregation(Aggregation.match(criteria), Aggregation.group("workDate"));
    ...
    // 获取医院名称
    String hosName = hospitalRepository.getHospitalByHoscode(hoscode).getHosname();
    // 其他基础数据
  ...
  private void packageSchedule(Schedule schedule) {
    ...
    schedule
            .getParam()
            .put("depname", departmentService.getDepName(schedule.getHoscode(), schedule.getDepcode()));
    // 设置日期对应星期
